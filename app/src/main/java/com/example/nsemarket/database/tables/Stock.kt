...
class Stock(
        @field:Expose @field:SerializedName("change") var change: Double,
        @field:Expose @field:SerializedName("pChange") var pChange: Double,
        @field:Expose @field:SerializedName("identifier")
